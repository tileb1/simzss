...
def get_parser_args():
    ...
    parser_eval.add_argument('--task', type=str, default="auto",
                             choices=["zeroshot_classification", "zeroshot_retrieval", "linear_probe", "captioning",
...
def main_eval(base):
    # Hard-coded stuff
    base.n_dense_cls = 1
    base.mask_type_text = "causal"
    base.denoiser_type = "transformer"
    base.visual_norm = None
    base.n_decoder_layers = 1
    base.n_decoder_heads = 1
    base.n_classes = 0
    base.beta_ema = 0.
    base.decoder_type = "shallow"
    base.decoder_softmax_dim = "patch"
